    ...
    return (
        <footer className="bg-black text-white py-4 px-6 mt-auto border-t border-gray-800">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                {/* Sol Kısım: İletişim ve Konum (Modern Zinc Tasarımı) */}
                <div className="flex gap-3 order-2 md:order-1">
                    <a
                        href="mailto:cetinkayavinc@gmail.com"
                ...
                {/* Orta Kısım: Telif Hakkı ve Tasarımcı Bilgisi */}
                <div className="text-center order-1 md:order-2">
                    <p className="text-[10px] md:text-xs text-gray-400 uppercase tracking-widest">
                        © {new Date().getFullYear()} Çetinkaya Vinç | Tüm Hakları Saklıdır
                    </p>
                    <div className="mt-1">
                        <Link
                        ...
                        >
                            Sayfa Tasarımı için | <span className="font-bold">Balaban</span>
                        </Link>
                    </div>
                </div>

                {/* Sağ Kısım: Hizalama Dengesi */}
                <div className="hidden md:block w-[150px] order-3"></div>
            </div>

            {/* Sabit WhatsApp Butonu */}
            <a
                href="https://wa.me/905065191804"
                target="_blank"
                rel="noopener noreferrer"
