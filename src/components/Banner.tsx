    ...
    <div className="container mt-12 mx-auto px-4 lg:px-8 font-lora">
      <div className="flex flex-col md:flex-row shadow-xl rounded-2xl overflow-hidden border border-gray-100 dark:border-slate-700">
        ...
        <div className="md:w-1/2 relative min-h-[300px] md:min-h-full">
          <img
              src="/banner.jpg"
              alt="Vinç Mühendislik ve Hizmet"
        ...
        <span className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm mb-2">
          ...
          <div className="space-y-4 mb-8">
            {[
              "Vinç ve kaldırma teknolojilerinde uzmanız",
              "Ağır sanayi ve hidrolik sistemlere yön veriyoruz",
              "Güvenlik ve hassas mühendislik temel ilkemiz"
            ].map((text, index) => (
          ...
          <p className="text-base md:text-lg leading-relaxed text-slate-600 dark:text-slate-400 font-sans italic">
            Yüksek tonajlı kaldırma çözümlerinden periyodik bakım hizmetlerine kadar,
            şantiyelerinizde ve endüstriyel tesislerinizde iş güvenliğini odağımıza alarak
            kesintisiz operasyon desteği sağlıyoruz. Güçlü filomuz ve uzman kadromuzla
            sektörün yükünü sırtlanıyoruz.
          </p>
        </div>
